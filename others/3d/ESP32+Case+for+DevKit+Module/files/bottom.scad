...
difference() {
    union() {
        ...
        /* pin holders */
        /*
        translate([1.75+1.65, 0.8+1.65, 2])           cube([length-1.65*2-1.75*2, 3.5, 5]);
        translate([1.75+1.65, width-1.65-0.8-3.5, 2]) cube([length-1.65*2-1.75*2, 3.5, 5]);
        */
        ...
        */
        ...
        translate([1.65, 1.65, 7]) difference() {
